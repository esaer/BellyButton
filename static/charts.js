...
function buildCharts(sample) {
  ...
  var fs = filteredsamples[0];

    // 2. Create a variable that holds the first sample in the metadata array.
  var fm = filteredmetadata[0];

    // 6. Create variables that hold the otu_ids, otu_labels, and sample_values.
  var otuids = fs.otu_ids;
  var otulabels = fs.otu_labels;
  var samplevalues = fs.sample_values;
  ...
  var wf =fm.wfreq;
    ...
    // 7. Use Plotly to plot the gauge data and layout.
